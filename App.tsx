        ...
        <nav className="flex justify-around items-center h-14 px-2">
          ...
          >
            <div className="relative">
              <svg xmlns="http://www.w3.org/2000/svg" className={`h-5 w-5 mb-1 transition-all duration-500 ease-out ${watchlistGlow ? 'text-green-500 drop-shadow-lg scale-110' : 'scale-100'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
